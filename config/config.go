...
var CLI struct {
	Serve struct {
		...
		APIKey       string `name:"api-key" env:"CONNECTIVLY_API_KEY" default:"local-api-key"`
		ProviderName string `name:"provider-name" env:"CONNECTIVLY_PROVIDER_NAME" default:"local-provider-name"`
